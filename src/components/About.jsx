        ...
        <div>
          ...
          <div className="space-y-5">
            ...
            <p ref={p2} className="text-base leading-[1.9] text-grey-muted font-light">
              With a focus on <strong className="text-white font-normal">MERN Stack and AI-powered applications</strong>, I try turning ideas into scalable, production-ready products that real users love. Every line of code is written with intent.
            </p>
